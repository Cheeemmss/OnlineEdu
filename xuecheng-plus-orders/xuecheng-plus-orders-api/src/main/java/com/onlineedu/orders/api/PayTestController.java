package com.onlineedu.orders.api;
...
import static com.onlineedu.orders.config.AlipayConfig.CHARSET;
...
//        alipayRequest.setReturnUrl("http://domain.com/CallBack/return_url.jsp");
        alipayRequest.setNotifyUrl("http://93jubz.natappfree.cc/orders/notify");//在公共参数中设置回跳和通知地址
        alipayRequest.setBizContent("{" +
                "    \"out_trade_no\":\"202210100010101004\"," +
                "    \"total_amount\":0.1," +
                "    \"subject\":\"Iphone13plus 256G\"," +
